    ...
    <div className="flex items-center justify-center bg-gray-100 p-6">
      <div className="flex flex-row items-center bg-white rounded-2xl shadow-lg max-w-7xl p-6">
        <div className="w-1/3 p-4">
          <img src={image} alt="About Us" className="rounded-xl w-[100%] h-[100]" />
        </div>
        <div className="w-2/3 text-left p-4">
          <p className="text-lg text-gray-600 mb-4">
            ...
            <li className='list-none'>✔ <span className="font-semibold">Curated Selection</span> – We handpick high-quality products to ensure you get the best.</li>
            <li className='list-none'>✔ <span className="font-semibold">Fast & Secure Checkout</span> – Your time matters, and so does your security.</li>
            <li className='list-none'>✔ <span className="font-semibold">Exceptional Customer Support</span> – We're here for you, every step of the way.</li>
            <li className='list-none'>✔ <span className="font-semibold">Worldwide Shipping</span> – No matter where you are, we deliver to your doorstep.</li>
